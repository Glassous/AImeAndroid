...
abstract class ChatDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_7_8 = object : Migration(7, 8) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Add errorDetails column to store detailed error information
                db.execSQL("ALTER TABLE chat_messages ADD COLUMN errorDetails TEXT")
            }
        }

        private val MIGRATION_8_9 = object : Migration(8, 9) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Add imagePaths column
                db.execSQL("ALTER TABLE chat_messages ADD COLUMN imagePaths TEXT NOT NULL DEFAULT '[]'")
            }
        }
        ...
        private val MIGRATION_10_11 = object : Migration(10, 11) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Add version column to conversations with default value 1
                db.execSQL("ALTER TABLE conversations ADD COLUMN version INTEGER NOT NULL DEFAULT 1")
            }
        }
